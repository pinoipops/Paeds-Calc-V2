...
QUICK SHORTCUTS:
- Tap medication name = select medication
- Tap ⭐ = add/remove favourite
- Star action does not select medication
...
const DATA = {
    ...
    regimens:[
      {
        ...
        frequency:"BD",
        frequencySub:"twice daily",
        notes:["Maximum 5mL/24h."]
      },
      {
        label:"2–6y: 2.5mL every 4–6h",
        ageMin:2,
        ageMax:5.99,
        fixedMl:2.5,
        frequency:"Every 4–6 hourly",
        frequencySub:"PRN",
        notes:["Maximum 15mL/24h."]
      },
      {
        label:"6–12y: 5mL every 4–6h",
        ageMin:6,
        ageMax:11.99,
        fixedMl:5,
        frequency:"Every 4–6 hourly",
        frequencySub:"PRN",
        notes:["Maximum 30mL/24h."]
      },
      {
        label:">12y: 10mL every 4–6h",
        ageMin:12,
        ageMax:99,
        fixedMl:10,
        frequency:"Every 4–6 hourly",
        frequencySub:"PRN",
        notes:["Maximum 60mL/24h."]
      }
    ]
  },
  ...
  benadryl:{
    ...
    regimens:[
      {
        label:"<6y: do not auto-dose",
        ageMin:0,
        ageMax:5.99,
        blocked:true,
        frequency:"—",
        notes:[
          "Use only when specifically directed; product labelling varies by formulation."
        ]
      },
      {
        label:"6–11y: 5–10mL every 4–6h",
        ageMin:6,
        ageMax:11.99,
        rangeMl:[5,10],
        frequency:"Every 4–6 hourly",
        frequencySub:"PRN",
        notes:["Maximum 6 doses in 24h."]
      },
      {
        label:"≥12y: 10–20mL every 4–6h",
        ageMin:12,
        ageMax:99,
        rangeMl:[10,20],
        frequency:"Every 4–6 hourly",
  ...
  tussidex:{
    ...
    regimens:[
      {
        label:"<6y: no automatic dose",
        ageMin:0,
        ageMax:5.99,
        blocked:true,
        frequency:"—",
        notes:[
          "Product information advises medical assessment for children below 6 years."
        ]
      },
      {
        label:"≥6y: 5mL up to TDS",
        ageMin:6,
        ageMax:99,
        fixedMl:5,
        frequency:"Up to TDS",
  ...
  coughen:{
    ...
    concentrations:[
      {
        label:"15mg/5mL dextromethorphan + 5mg/5mL phenylephrine + 1.25mg/5mL triprolidine",
        mgPerMl:3
      }
    ],
    regimens:[
      {
        label:"<2y: contraindicated",
        ageMin:0,
        ageMax:1.99,
        blocked:true,
        frequency:"—",
        notes:["Not for children below 2 years."]
      },
      {
        label:"2–5y: 2.5mL TDS",
        ageMin:2,
        ageMax:5.99,
        fixedMl:2.5,
        frequency:"TDS",
        frequencySub:"three times daily"
      },
      {
        label:"6–12y: 5mL TDS",
        ageMin:6,
  ...
  paedicof:{
    ...
    concentrations:[
      {
        label:"5mg dextromethorphan + 15mg pseudoephedrine + 1mg dexchlorpheniramine /5mL",
        mgPerMl:1
      }
    ],
    regimens:[
      {
        label:"<2y: not recommended",
        ageMin:0,
        ageMax:1.99,
        blocked:true,
        frequency:"—",
        notes:["Not recommended below 2 years."]
      },
      {
        label:"2–5y: 5mL every 4–6h",
        ageMin:2,
        ageMax:5.99,
        fixedMl:5,
        frequency:"Every 4–6 hourly",
  ...
  salmodil:{
    ...
    concentrations:[
      {
        label:"Salbutamol 2mg + Bromhexine 4mg /5mL",
        mgPerMl:0.4
      }
    ],
    regimens:[
      {
        label:"<6y: 1.25–2.5mL TDS–QID",
        ageMin:0,
        ageMax:5.99,
        rangeMl:[1.25,2.5],
        frequency:"TDS–QID",
        frequencySub:"as directed",
        notes:["Use the lower end initially in smaller children."]
      },
      {
        label:"≥6y: 2.5–5mL TDS–QID",
        ageMin:6,
        ageMax:99,
        rangeMl:[2.5,5],
        frequency:"TDS–QID",
  ...
  colimix:{
    ...
    concentrations:[
      {
        label:"Dicyclomine 5mg + Simethicone 50mg /5mL",
        mgPerMl:1
      }
    ],
    regimens:[
      {
        label:"<0.5y: contraindicated",
        ageMin:0,
        ageMax:0.49,
        blocked:true,
        frequency:"—",
        notes:["Dicyclomine is not recommended below 6 months."]
      },
      {
        label:"0.5–4y: 5mL before feeds, max QID",
        ageMin:0.5,
        ageMax:3.99,
        fixedMl:5,
        frequency:"Before feeds, max QID",
        frequencySub:"maximum 4 doses/24h"
      },
      {
        label:"4–12y: 5–10mL QID",
        ageMin:4,
        ageMax:11.99,
        rangeMl:[5,10],
        frequency:"QID",
    ...
    regimens:[
      {
        ...
        fixedMg:1,
        frequency:"Up to TDS",
        frequencySub:"minimum 6h interval"
      },
      {
        label:"3–5y / 15–19kg: 2mg",
        ageMin:3,
        ageMax:4.99,
        minWeight:15,
        maxWeight:19,
    ...
    regimens:[
      {
        ...
        fixedMg:2.5,
        frequency:"PRN",
        frequencySub:"according to clinical response"
      },
      {
    ...
    regimens:[
      {
        ...
        fixedMl:1,
        frequency:"PRN",
        frequencySub:"according to acute protocol"
      }
    ]
  }
...
function buildShortcuts(){
  ...
  QUICK_SHORTCUTS.forEach(key=>{
    ...
    /*
      IMPORTANT:
      The star is kept as a separate interactive
      element. Tapping the medication name selects.
      Tapping the star toggles favourite only.
    */

    button.innerHTML=`
      <span class="shortcut-name">
        ${escapeHtml(DATA[key].name)}
      </span>
      <span
        class="star-btn"
        role="button"
    ...
    /* TAP MEDICATION NAME = SELECT */

    button
      .querySelector(".shortcut-name")
      .addEventListener(
        "click",
        ()=>{
    ...
    /* TAP STAR = ADD / REMOVE FAVOURITE */

    const star =
      button.querySelector(".star-btn");
...
function updateMedicationFields(){
  ...
  const drug =
    DATA[medicationSelect.value];

  concentrationSelect.innerHTML="";
  regimenSelect.innerHTML="";


  drug.concentrations.forEach(
    (item,index)=>{
