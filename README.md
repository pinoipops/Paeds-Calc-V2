...
| **Gastrointestinal** | Domperidone, Hyoscine Butylbromide (Buscopan), Dicyclomine + Simethicone (Colimix), Metoclopramide (Maxalon) |
| **Cough & Decongestants** | Salbutamol + Bromhexine (Salmodil), Dextromethorphan (Tussidex), DXM + Phenylephrine (Cough-En), Pseudoephedrine (Paedicof) |
